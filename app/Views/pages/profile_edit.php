<?php
/* Vue MVC — Page de modification du profil utilisateur
   Objectif : permettre à l’utilisateur de mettre à jour ses infos personnelles,
   son avatar, ses préférences de covoiturage et éventuellement son mot de passe.
*/

/* Helper d’échappement : je protège tout affichage venant des données utilisateur. */
function e($s){ return htmlspecialchars((string)$s, ENT_QUOTES, 'UTF-8'); }

/** @var array|null $user  Données utilisateur existantes (DB)
 *  @var array|null $prefs Préférences utilisateur (smoking, pets, music…)
 *  @var string     $title Titre de la page
 */

/* Closure utilitaire pour lire une préférence avec fallback */
$pref = function($k, $default = 0) use ($prefs) {
  $v = $prefs[$k] ?? $default;
  return (string)$v;
};

/* Fonction utilitaire : calculer l’âge à partir de la date de naissance */
...
/* Je calcule directement l’âge de l’utilisateur pour l’afficher en lecture seule */
...
<div class="container my-4">
  ...
  <form method="post" action="<?= BASE_URL ?>profile/edit" class="row g-3" enctype="multipart/form-data">
    <!-- Champ CSRF caché pour sécuriser le POST -->
    ...
    <div class="col-12">
      ...
      <div class="d-flex align-items-center gap-3">
        <?php
        // Je prends l’avatar du user, sinon celui en session, sinon un placeholder
    ...
    <!-- Date de naissance + affichage âge -->
    <div class="col-md-6">
