...
final class UserPreferences
{
    ...
    public static function get(int $userId): array
    {
        ...
        return $st->fetch(PDO::FETCH_ASSOC) ?: [
            'user_id'=>$userId, 'smoker'=>0, 'animals'=>0, 'music'=>1, 'chatty'=>1, 'ac'=>1, 'custom_prefs'=>null
        ];
    }
    ...
    public static function upsert(int $userId, array $d): bool
    {
        $sql = "INSERT INTO user_preferences (user_id, smoker, animals, music, chatty, ac, custom_prefs)
                ...
                ON DUPLICATE KEY UPDATE
                  smoker=VALUES(smoker), animals=VALUES(animals), music=VALUES(music),
                  chatty=VALUES(chatty), ac=VALUES(ac), custom_prefs=VALUES(custom_prefs)";
