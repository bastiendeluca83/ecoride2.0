...
if (isset($_GET['error'])) {
    switch ($_GET['error']) {
        case 'badcreds':
            ...
            break;
        case 'suspended':
            $errorMessage = "Votre compte est suspendu. Contactez l'administrateur.";
            break;
        case 'csrf':
            $errorMessage = "Session expirée. Merci de réessayer.";
            break;
    }
}
                ...
                <ul class="nav nav-pills gap-2 mb-3" id="authTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="tab-login" data-bs-toggle="tab"
                                ...
                                aria-controls="pane-login" aria-selected="true">Connexion</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="tab-signup" data-bs-toggle="tab"
                                data-bs-target="#pane-signup" type="button" role="tab"
                                aria-controls="pane-signup" aria-selected="false">Inscription</button>
                    </li>
                </ul>
            </div>
            ...
            <div class="tab-content px-3 pb-3">
                ...
                <div class="tab-pane fade" id="pane-signup" role="tabpanel" aria-labelledby="tab-signup">
                    <form method="post" action="/signup" class="needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                            <label for="signupPass" class="form-label">Mot de passe</label>
                            <input type="password" class="form-control" id="signupPass" name="password" required>
                            <div class="invalid-feedback">Mot de passe requis.</div>
                        </div>
